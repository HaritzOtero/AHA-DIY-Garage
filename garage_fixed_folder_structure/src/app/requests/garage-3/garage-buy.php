...
?>
    ...
    <?php
			...
			if ($MAXrent >= $MAXsell){
				...
				$emaitza=mysqli_query($link,"select week, Hours from garage_3 where session = $session and buy = '0'");
					while($erregistroa = mysqli_fetch_array($emaitza))
					{
						...
						echo "<br>";
							...
							mysqli_query($link, "INSERT INTO renting  VALUES ($MAXrent,$userID,3,NOW(),$week, '$Hours', NULL)");
				...
				mysqli_query($link,"update garage_3 set buy = 1 where session = $session");
